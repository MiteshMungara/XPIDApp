...
class Toast: NSObject {
    ...
    static func long(message: String,success: String,failer: String) {
        ...
        DispatchQueue.main.async {
            ...
            if success == "1"
            {
                t.toastView?.imageV.backgroundColor = UIColor(red: 41.0/255.0, green: 177.0/255.0, blue: 114/255.0, alpha: 1)
                //t.toastView?.imageV.image = UIImage(named: "toest_success")
            }
            else
            {
              //  t.toastView?.imageV.image = UIImage(named: "toest_failer")
                 t.toastView?.imageV.backgroundColor = UIColor(red: 250.0/255.0, green: 93.0/255.0, blue: 93/255.0, alpha: 1)
            }
            if toastTimer == nil {
